...
import { MatButtonModule, MatCheckboxModule, MatCardModule, MatTableModule, MatGridListModule, MatToolbarModule, MatFormFieldModule, MatInputModule, MatProgressSpinnerModule } from '@angular/material';
...
//   return () => oidcConfigService.load(`assets/config/config.json`);
// }
